        ...
        <div className="ab-modal-backdrop" onClick={e => { if(e.target===e.currentTarget) setOpen(false); }}>
          <div className="ab-modal">
            ...
            <div style={{ padding:"32px 32px 0", paddingTop:24 }}>
              ...
              {/* Avatar row */}
              <div style={{ display:"flex", alignItems:"flex-end", gap:16, marginTop:-28, paddingLeft:4 }}>
                ...
                <div style={{ marginLeft:"auto", paddingBottom:8, display:"flex", gap:8 }}>
            ...
            <div style={{ padding:"24px 32px 32px", display:"flex", flexDirection:"column", gap:24 }}>
              ...
              <div>
                ...
                <div style={{ display:"flex", gap:10, flexWrap:"wrap" }}>
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="ab-social-btn" style={{ color:"rgba(255,255,255,0.7)" }}>
                    <Github /> GitHub
                  </a>
                  <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="ab-social-btn" style={{ color:"#60a5fa" }}>
                    <Linkedin /> LinkedIn
                  </a>
